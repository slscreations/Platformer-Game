...
def get_block(size):
    ...
    rect = pygame.Rect(0, 0, size, size) #128 for green blocks
...
def main(window):
    ...
    fire = Fire(2239, HEIGHT - block_size - 680, 16, 32)
    fire.on()
    ...
    objects = [*floor, Block(0, HEIGHT - block_size * 2, block_size),
               ...
               Block(block_size * 24, HEIGHT - block_size * 5, block_size), fire, fire]
